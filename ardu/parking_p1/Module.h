...
// CODEX FIX:
// client_2.ino registers 10 physical modules
// (5 sensors, 2 servos, and 3 LEDs). This comparison header pins that contract
// to 10 before loading the original registration implementation. The original
// worktree was also changed to 10 by the user during this task, so this define
// is now an explicit guard rather than a behavioral difference.
//
// Hardware verification is still required: remeasure AVR free RAM after
// compiling and during a long-running link test before deploying this copy
#ifndef MODULE_CAP
